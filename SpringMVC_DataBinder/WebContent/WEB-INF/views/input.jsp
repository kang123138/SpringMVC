...
<body>
	...
	<!-- 添加员工时显示用户名 -->
		<c:if test="${empty requestScope.employee.id }">用户名：<form:input path="lastName" /><form:errors path="lastName"> </form:errors><br></c:if>
		...
		生日：<form:input path="birth" /><form:errors path="birth"> </form:errors><br>
		工资：<form:input path="money"/><form:errors path="money"></form:errors>
		<input type="submit">
	</form:form>
</body>
</html>